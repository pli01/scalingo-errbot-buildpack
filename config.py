...
BOT_EXTRA_BACKEND_DIR = os.environ.get(
    'BOT_EXTRA_BACKEND_DIR', '/app/errbackends')

BOT_EXTRA_STORAGE_PLUGINS_DIR = os.environ.get(
    'BOT_EXTRA_STORAGE_PLUGINS_DIR', '/app/errstorage')
...
BOT_LOG_FILE = os.environ.get('BOT_LOG_FILE', None)
...
# scheme
if 'BOT_SCHEME' in os.environ:
    BOT_IDENTITY['scheme'] = os.environ['BOT_SCHEME']

# scheme
if 'BOT_TEAM' in os.environ:
    BOT_IDENTITY['team'] = os.environ['BOT_TEAM']
...
#                   'help': {'allowmuc': False},
#                  }
if 'ACCESS_CONTROLS' in os.environ:
    ACCESS_CONTROLS = ast.literal_eval(os.environ.get('ACCESS_CONTROLS'))
#ACCESS_CONTROLS = {'status': {'allowprivate': True, 'allowusers': BOT_ADMINS },
#                   'about': {'allowrooms': ('#testroom')},
#                   'uptime': {'allowusers': BOT_ADMINS},
#                   'help': {'allowrooms': ('#testroom')},
#                   'hello': {'allowrooms': ('#testroom')},
#                  }
#
